from PyQt5.QtWidgets import QWidget, QListWidget, QHBoxLayout, QVBoxLayout, QPushButton, QLabel, QLineEdit
...
btn_add_qustion = QPushButton('Добавить вопрос')
btn_clear = QPushButton('Очистить')

h1_buttons = QHBoxLayout()
h1_buttons.addWidget(btn_add_qustion)
